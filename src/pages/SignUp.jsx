...
const SignUp = () => {
    ...
    return(
        <>
            <form className="grid grid-cols-1 sm:grid-cols-2 sm:min-h-screen" onSubmit={handleSignUp} >
                ...
                <div className="flex flex-col justify-start mx-6 pt-14 lg:pt-24">
                    <div className="font-bold text-3xl text-sky-600 uppercase pb-6"> Sign Up </div>
                    <Input
                        name="name"
                        value={formData.name}
                    ...
                    {message.text && (
                        <div className={`pb-4 ${message.type === "success" ? "text-green-700" : "text-red-700"}`}>
                            {message.text}
                        </div>
                    )}
